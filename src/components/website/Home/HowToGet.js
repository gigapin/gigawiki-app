  ...
  return (
    ...
    <div className="grid gap-10 lg:grid-cols-2">
      ...
      <div className="border-2 border-teal-200 p-8 rounded-lg shadow-sm">
        ...
        <div className="my-4 text-lime-400"><p>GiGaWiki is a self-hosted application, can be downloaded from this GitHub's page or directly from the link below</p></div>
        <div className="">
