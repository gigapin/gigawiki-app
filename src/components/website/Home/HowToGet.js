  ...
  return (
    ...
    <div className="grid gap-10 lg:grid-cols-2">
      ...
      <div className="border-2 border-teal-200 p-8 rounded-lg shadow-sm">
        ...
        <div className="my-4 text-lime-700"><p>GiGaWiki is a self-hosted application, can be downloaded from this GitHub's page or directly from the link below</p></div>
        <div className="">
          <button className="py-2 px-4 bg-teal-400 text-white mr-4 rounded-sm">Download</button>
          <a href="https://github.com/gigapin/GiGaWiki" target="_blank" rel="noreferrer">GitHub</a>
        </div>
      </div>
      ...
      <div className="border-2 border-teal-200 p-8 rounded-lg shadow-sm">
        ...
        <div className="my-4 text-lime-700">
          <p>
        ...
        <div className="">
          <a href="http://gigawiki.test/libraries" target="_blank" rel="noreferrer">Go to documentation</a>
        </div>
      </div>
