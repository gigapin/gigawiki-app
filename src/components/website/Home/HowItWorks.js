  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-12">
      ...
      <div className="grid justify-items-center lg:gap-1 lg:grid-cols-2 mt-6 lg:h-24 mx-auto lg:max-w-screen-lg">
        <div className="bg-white dark:bg-lime-600 h-24 rounded-tl-3xl rounded-bl-3xl mb-4 w-9/12 md:w-8/12 lg:w-10/12">
        ...
        <div className="bg-white dark:bg-lime-600 h-24 rounded-tr-3xl rounded-br-3xl mb-4 w-9/12 md:w-8/12 lg:w-10/12">
          <div className='inline-flex items-center'>
