...
const Sidebar = () => {
  return (
    <div id="drawer-navigation" className="fixed z-40 h-screen p-4 overflow-y-auto bg-white lg:w-60 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
